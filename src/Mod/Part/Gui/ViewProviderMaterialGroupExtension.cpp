...
#include <Mod/Part/App/MaterialGroupExtension.h>

#include "ViewProviderMaterialGroupExtension.h"

// #include "ViewProviderFeatureMaterial.h"
...
EXTENSION_PROPERTY_SOURCE(PartGui::ViewProviderMaterialGroupExtension,
        ...
        const std::vector<App::DocumentObject*> &children ) const
{
    ...
    auto* group = obj
        ? obj->getExtensionByType<Part::MaterialGroupExtension>()
        : nullptr;
    if(!group)
        return children;
...
void ViewProviderMaterialGroupExtension::extensionUpdateData( const App::Property* prop ) {
    ...
    // auto* obj = getExtendedViewProvider()->getObject();
    // auto* group = obj ? obj->getExtensionByType<Part::FeatureMaterialRootExtension>() : nullptr;
...
void ViewProviderMaterialGroupExtension::slotChangedObjectApp ( const App::DocumentObject& obj) {
    ...
    // auto* group = ext ? ext->getExtensionByType<Part::FeatureMaterialRootExtension>() : nullptr;
...
//     auto* group = owner->getExtensionByType<Part::FeatureMaterialRootExtension>();
//     if(!group)
//         return;
...
namespace Gui
{
EXTENSION_PROPERTY_SOURCE_TEMPLATE(PartGui::ViewProviderMaterialGroupExtensionPython, PartGui::ViewProviderMaterialGroupExtension)

// explicit template instantiation
template class PartGuiExport ViewProviderExtensionPythonT<ViewProviderMaterialGroupExtension>;
}  // namespace Gui
