...
#ifndef PARTGUI_VIEWPROVIDERFEATUREMATERIALROOT_H
#define PARTGUI_VIEWPROVIDERFEATUREMATERIALROOT_H
...
class PartGuiExport ViewProviderFeatureMaterialRoot: public Gui::ViewProviderDocumentObject
{
    PROPERTY_HEADER_WITH_OVERRIDE(PartGui::ViewProviderFeatureMaterialRoot);
...
public:
    ...
    /// constructor.
    ViewProviderFeatureMaterialRoot();
    /// destructor.
    ~ViewProviderFeatureMaterialRoot() override;
...
#endif  // PARTGUI_VIEWPROVIDERFEATUREMATERIALROOT_H
