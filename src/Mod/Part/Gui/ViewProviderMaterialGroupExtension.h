...
#ifndef PARTGUI_VIEWPROVIDERMATERIALGROUPEXTENSION_H
#define PARTGUI_VIEWPROVIDERMATERIALGROUPEXTENSION_H

#include <Gui/ViewProviderGeoFeatureGroup.h>


namespace PartGui
{

class PartGuiExport ViewProviderMaterialGroupExtension : public Gui::ViewProviderGeoFeatureGroupExtension
{
    EXTENSION_PROPERTY_HEADER_WITH_OVERRIDE(PartGui::ViewProviderMaterialGroupExtension);

public:
    /// Constructor
    ViewProviderMaterialGroupExtension();
    ~ViewProviderMaterialGroupExtension() override;
...
using ViewProviderMaterialGroupExtensionPython =
    Gui::ViewProviderExtensionPythonT<PartGui::ViewProviderMaterialGroupExtension>;

}  // namespace PartGui

#endif  // PARTGUI_VIEWPROVIDERMATERIALGROUPEXTENSION_H
