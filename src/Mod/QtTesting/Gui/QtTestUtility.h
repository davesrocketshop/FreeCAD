...
#include <Mod/QtTesting/QtTestingGlobal.h>
...
class QtTestingGuiExport QtTestUtility: public pqTestUtility, public Base::BaseClass
{
...
public:
    ...
    static QtTestUtility& getTestUtility();

private:
    static std::unique_ptr<QtTestUtility> qtTestUtility;
};
