...
#ifndef GUI_VIEWPROVIDERMATERIALGROUPEXTENSION_H
#define GUI_VIEWPROVIDERMATERIALGROUPEXTENSION_H
...
class GuiExport ViewProviderMaterialGroupExtension : public ViewProviderGeoFeatureGroupExtension
{
    EXTENSION_PROPERTY_HEADER_WITH_OVERRIDE(Gui::ViewProviderMaterialGroupExtension);
...
using ViewProviderMaterialGroupExtensionPython = ViewProviderExtensionPythonT<Gui::ViewProviderMaterialGroupExtension>;

} //namespace Gui

#endif  // GUI_VIEWPROVIDERMATERIALGROUPEXTENSION_H
