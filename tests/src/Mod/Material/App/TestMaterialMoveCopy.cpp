...
class MaterialManagerProxy : public Materials::MaterialManager {
public:
    using Materials::MaterialManager::crossMoveFolder;
};

class TestMaterialMoveCopy : public ::testing::Test {
protected:
    ...
    void SetUp() override {
        ...
        _materialManager = static_cast<MaterialManagerProxy *>(&(Materials::MaterialManager::getManager()));
